...
void Func_NativeOutputOn();
void Func_NativeOutputOff();
...
void SettingsFrame::activateSubmenu(int submenu)
{
	...
	{						//Config buttons: set visible; set selected
		...
		case SUBMENU_VIDEO:
			...
			if (nativeOutput == NATIVEOUT_ENABLE)	FRAME_BUTTONS[27].button->setSelected(true);
