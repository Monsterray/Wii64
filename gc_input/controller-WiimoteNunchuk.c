...
static void assign(int p, int v){
	...
	// convention rather than a binary player-count encoding. Shared by both
	// controller_Wiimote and controller_WiimoteNunchuk below -- same
	// physical device either way.
